...
bool UI_Constructor::decodeEnqueueReady(qint32 k, qint32 k0) {
    ...
    qCDebug(decoder_js8) << "? JS8 4/250    " << currentDecodeStartI
                         << nextDecodeStartI;
    couldDecodeI =
...
void UI_Constructor::prepareSending(qint64 nowMS) {
    ...
    if (m_nSubMode == Varicode::JS8CallFast) {
        ...
        // for the JS8 6/160 (formerly "Turbo") and JS8 4/250
...
void UI_Constructor::setXIT(int audio_freq) {
    ...
    // the audio actually transmitted is 1500 - 2160 Hz (JS8 6/160 has 160 Hz
